    ...
    switch(template_ns) {
      case 'zkyasze0q8tquwio0fnirvbdgcp0luva':
        return {
          ...
          videoDescription: 'Aprende a configurar el seguimiento de guías y solución de novedades.',
          benefits: [
    ...
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-red-500 mb-4">Asistente no encontrado</h2>
          <button 
            onClick={() => navigate('/')}
