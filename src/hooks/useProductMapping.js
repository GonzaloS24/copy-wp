...
export const useProductMapping = () => {
  ...
  const mapApiDataToProductData = useCallback(
    (apiData) => {
      ...
      return {
        info: {
          formData: {
            ...
            price:
              infoProducto.precio_del_producto || infoProducto.precio || "",
            id: infoProducto.id || infoProducto.id_dropi || "",
            productType:
              infoProducto.tipo || infoProducto.tipo_de_producto || "",
            image:
          ...
          isActive:
            infoProducto.estado === "activo" ||
            infoProducto.estado_producto === "activo",
        },
        messageWel: {
          formData: {
            initialMessage:
              embudoVentas.mensaje_inicial ||
              "¡Hola! Soy Laura, bienvenida a Master Shop.",
            entryQuestion:
              embudoVentas.pregunta_de_entrada ||
        ...
        freePrompt: {
          ...
          guidePromptData:
            tipoPrompt === "guiado" ? guidePromptData : undefined,
        },
        voice: {
          ...
          useSpeakerBoost:
            vozIA.speaker_boost === "true" || vozIA.speaker_boost === true,
          useVoiceAI: vozIA.habilitar === "si" || vozIA.habilitar === true,
        },
        reminder: {
          reminder1: {
          ...
          timeRange: {
            ...
            minTime:
              recordatorios.hora_min || recordatorios.horario_minimo || "09:00",
            maxTime:
              recordatorios.hora_max || recordatorios.horario_maximo || "20:00",
          },
        },
        remarketing: {
          remarketing1: {
