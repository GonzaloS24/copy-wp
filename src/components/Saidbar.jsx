...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white w-96 h-full shadow-xl transform transition-transform duration-300 ease-[cubic-bezier(0.25,0.8,0.25,1)] flex flex-col ${
      ...
      >
        <div className="p-8 pb-6 border-b border-slate-200 bg-gradient-to-br from-slate-50 to-slate-100">
          <div className="flex items-center justify-center gap-3 p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
            <img src={chatea} alt="logo de chatea" width={200} />
          </div>
        </div>
