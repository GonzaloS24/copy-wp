...
const OpenAIWarningModal = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 animate-in fade-in duration-300">
      <div className="max-w-md w-full mx-auto bg-white rounded-2xl shadow-xl p-6 relative animate-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">Integración requerida</h3>
          <p className="text-gray-600 mb-4">No has realizado la integración con OpenAI</p>
        </div>

        <div className="bg-yellow-50 p-4 rounded-lg mb-6">
          <p className="text-sm text-yellow-800 text-center">
            Por favor dirígete a la sección de integraciones para configurar tu API key de OpenAI y poder utilizar esta funcionalidad.
          </p>
        </div>
