  ...
  return (
    <>
      <div className="bg-white rounded-2xl p-10 shadow-xl border border-slate-200 w-full relative z-5">
        ...
        <div className="mb-12 p-8 border border-slate-200 rounded-2xl bg-white shadow-lg">
          <h3 className="text-2xl font-bold text-sky-500 mb-8 tracking-tight">
            1. Mensajes de recuperación
          </h3>
          <div className="grid grid-cols-3 gap-6 items-start">
            {/* Paso 1: Posición de la imagen */}
            <div className="bg-slate-50 hover:bg-white border border-slate-200 hover:border-sky-500 rounded-2xl p-6 flex flex-col items-center gap-4 transition-all duration-200 hover:-translate-y-1 shadow-sm hover:shadow-lg">
            ...
            <div className="bg-slate-50 hover:bg-white border border-slate-200 hover:border-sky-500 rounded-2xl p-6 flex flex-col items-center gap-4 transition-all duration-200 hover:-translate-y-1 shadow-sm hover:shadow-lg">
              ...
              <button
                className="bg-gradient-to-r from-sky-500 to-sky-600 text-white border-none rounded-xl py-4 px-6 text-base font-semibold cursor-pointer transition-all duration-200 font-inherit shadow-lg hover:-translate-y-1 hover:shadow-xl"
          ...
          <div className="grid grid-cols-2 gap-8 items-start">
            <div className="flex flex-col">
              ...
              <div className="flex gap-0">
                <input
                  type="number"
                  className="flex-1 p-4 border-2 border-slate-200 border-r-0 rounded-l-xl text-base text-center bg-white text-slate-700 min-w-25 focus:outline-none focus:border-sky-500 focus:shadow-lg focus:shadow-sky-500/10"
                  min="1"
                  placeholder="5"
                ...
                />
                <select
                  className="flex-2 p-4 border-2 border-slate-200 rounded-r-xl text-base bg-white text-slate-700 cursor-pointer min-w-35 focus:outline-none focus:border-sky-500 focus:shadow-lg focus:shadow-sky-500/10"
      ...
      <div className="bg-white rounded-2xl p-4 shadow-xl border border-slate-200 w-full mt-12">
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 text-center">
          <h3 className="text-xl font-bold text-slate-500 mb-2 text-center">
            Reinstalación de plantillas
          </h3>
          <p className="text-sm font-normal text-slate-400 italic text-center mb-4">
            (solo en casos especiales)
          </p>
          <p className="text-slate-500 text-sm leading-relaxed mb-6 max-w-125 mx-auto text-center">
      ...
      {showReinstallModal && (
        ...
        >
          <div
            className="bg-white rounded-2xl p-8 max-w-125 w-11/12 shadow-2xl animate-pulse"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                className="py-4 px-6 border-none rounded-xl text-base font-semibold cursor-pointer transition-all duration-200 font-inherit bg-sky-500 text-white shadow-lg hover:bg-sky-600 hover:-translate-y-1 hover:shadow-xl"
                onClick={closeReinstallModal}
              >
                No es lo que necesito
              </button>
              <button
                className="py-4 px-6 border-none rounded-xl text-base font-semibold cursor-pointer transition-all duration-200 font-inherit bg-red-600 text-white shadow-lg hover:bg-red-700 hover:-translate-y-1 hover:shadow-xl"
