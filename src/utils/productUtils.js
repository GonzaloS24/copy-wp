      ...
      data: [
        ...
        },
        {
          ...
          value: JSON.stringify({
            ...
            activadores_del_flujo: {
              palabras_clave:
                "perfume para carro, aroma duradero, ambientador elegante",
              ids_de_anuncio: "",
            },
          }),
          is_template_field: false,
        },
        {
          ...
          value: JSON.stringify({
            ...
            prompt: {
              tipo_de_prompt: "libre",
              prompt_libre:
                "Imagina que estás recomendando un peluche de nutria perfecto para regalar.",
              prompt_guiado_contextualizacion: "",
              prompt_guiado_ficha_tecnica: "",
              prompt_guiado_guion_conversacional: "",
              prompt_guiado_posibles_situaciones: "",
            ...
            activadores_del_flujo: {
              palabras_clave:
                "peluche nutria, regalo tierno, peluche abrazable",
              ids_de_anuncio: "",
            },
          }),
          is_template_field: false,
        },
        {
          ...
          value: JSON.stringify({
            ...
            prompt: {
              tipo_de_prompt: "libre",
              prompt_libre:
                "Busqueda, respuesta, similaridad, cortesia, etc...",
